...
public interface BeneficiaryAPI {
    ...
    ApiResponse<Beneficiary> createBeneficiary(Beneficiary beneficiary) throws UnipaymentSdkException;

    /**
     * Get a paged list of beneficiaries based on the provided search criteria.
     */
    @RequestLine("GET /beneficiaries")
    ApiResponse<QueryResult<Beneficiary>> queryBeneficiaries(@QueryMap QueryBeneficiaryRequest queryBeneficiaryRequest) throws UnipaymentSdkException;

    /**
     * Get a specific beneficiary by its ID.
     */
    @RequestLine("GET /beneficiaries/{id}")
    ApiResponse<Beneficiary> getBeneficiaryById(@Param("id") String beneficiaryId) throws UnipaymentSdkException;

    /**
     * Updates the details of a specific beneficiary.
     */
    @RequestLine("PUT /beneficiaries/{id}")
    ApiResponse<Beneficiary> updateBeneficiary(@Param("id") String beneficiaryId, Beneficiary beneficiary) throws UnipaymentSdkException;

    /**
     * Deletes a specific beneficiary by its Id.
     */
    @RequestLine("DELETE /beneficiaries/{id}")
    ApiResponse<Void> deleteBeneficiaryById(@Param("id") String beneficiaryId) throws UnipaymentSdkException;
    ...
    ApiResponse<PaymentMethod> createPaymentMethod(@Param("id") String beneficiaryId, PaymentMethod paymentMethod) throws UnipaymentSdkException;

    /**
     * Get a list of payment methods for a specific beneficiary.
     */
    @RequestLine("GET /beneficiaries/{id}/payment-methods")
    ApiResponse<List<PaymentMethod>> getPaymentMethodList(@Param("id") String beneficiaryId) throws UnipaymentSdkException;
    ...
    ApiResponse<PaymentMethod> getPaymentMethod(@Param("id") String beneficiaryId, @Param("payment-method-id") String paymentMethodId) throws UnipaymentSdkException;
    ...
    ApiResponse<PaymentMethod> updatePaymentMethod(@Param("id") String beneficiaryId, @Param("payment-method-id") String paymentMethodId, PaymentMethod paymentMethod) throws UnipaymentSdkException;
    ...
    ApiResponse<Void> deletePaymentMethod(@Param("id") String beneficiaryId, @Param("payment-method-id") String paymentMethodId) throws UnipaymentSdkException;
